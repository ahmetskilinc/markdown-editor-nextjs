	...
	return (
		<li className="col-span-1 flex flex-col divide-y divide-gray-200 rounded-lg bg-white shadow">
			<div className="flex grow flex-col p-6 gap-2 min-h-64">
				...
				<span className="inline-flex items-center grow rounded-md w-full max-h-64 overflow-hidden bg-gray-50 px-2 py-1 text-xs font-medium ring-1 ring-inset ring-gray-300/50">
					<pre>{sheet.content || "empty"}</pre>
				</span>
			</div>
			<div>
